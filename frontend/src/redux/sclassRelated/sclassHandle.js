...
export const deleteClass = (classID)=>async (dispatch)=>{
    try {
        await axios.delete(`${process.env.REACT_APP_BASE_URL}/deleteSclass/${classID}`);
    } catch (error) {
        dispatch(getError(error));
    }
}

export const deleteSubject = (classID)=>async (dispatch)=>{
    try {
        await axios.delete(`${process.env.REACT_APP_BASE_URL}/deleteSubject/${classID}`);
    } catch (error) {
        dispatch(getError(error));
    }
}